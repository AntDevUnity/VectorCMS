...
struct rt_VectorSite_ButtonForm : public bbClassTypeInfo{
  ...
  static struct decls_t : public bbClassDecls{
    decls_t():bbClassDecls(&instance){}
    bbDeclInfo **initDecls(){
      return bbMembers(bbCtorDecl<t_VectorSite_ButtonForm,bbInt,bbInt,bbInt,bbInt,bbString>(),bbFieldDecl("ButCol",&t_VectorSite_ButtonForm::m_ButCol),bbMethodDecl<t_VectorSite_ButtonForm,void,t_VectorSite_Button>("OnMouseUp",&t_VectorSite_ButtonForm::m_OnMouseUp),bbMethodDecl<t_VectorSite_ButtonForm,void>("OnMouseLeave",&t_VectorSite_ButtonForm::m_OnMouseLeave),bbMethodDecl<t_VectorSite_ButtonForm,void>("OnMouseEnter",&t_VectorSite_ButtonForm::m_OnMouseEnter),bbMethodDecl<t_VectorSite_ButtonForm,void,t_VectorSite_Button>("OnMouseDown",&t_VectorSite_ButtonForm::m_OnMouseDown),bbMethodDecl<t_VectorSite_ButtonForm,void>("OnDraw",&t_VectorSite_ButtonForm::m_OnDraw));
    }
  }decls;
