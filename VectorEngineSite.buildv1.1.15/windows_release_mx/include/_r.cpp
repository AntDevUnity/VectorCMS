...
struct rt_VectorSite_TextBoxForm : public bbClassTypeInfo{
  ...
  static struct decls_t : public bbClassDecls{
    decls_t():bbClassDecls(&instance){}
    bbDeclInfo **initDecls(){
      return bbMembers(bbCtorDecl<t_VectorSite_TextBoxForm,bbInt,bbInt,bbInt,bbInt,bbString>(),bbFieldDecl("Active",&t_VectorSite_TextBoxForm::m_Active),bbFieldDecl("ClaretOn",&t_VectorSite_TextBoxForm::m_ClaretOn),bbFieldDecl("NextOn",&t_VectorSite_TextBoxForm::m_NextOn),bbFieldDecl("KeyDown",&t_VectorSite_TextBoxForm::m_KeyDown),bbFieldDecl("KeyNext",&t_VectorSite_TextBoxForm::m_KeyNext),bbFieldDecl("ClaretX",&t_VectorSite_TextBoxForm::m_ClaretX),bbFieldDecl("StartX",&t_VectorSite_TextBoxForm::m_StartX),bbFieldDecl("Shift",&t_VectorSite_TextBoxForm::m_Shift),bbMethodDecl<t_VectorSite_TextBoxForm,void>("ShiftUp",&t_VectorSite_TextBoxForm::m_ShiftUp),bbMethodDecl<t_VectorSite_TextBoxForm,void>("ShiftDown",&t_VectorSite_TextBoxForm::m_ShiftDown),bbMethodDecl<t_VectorSite_TextBoxForm,void,bbInt>("ProcessKey",&t_VectorSite_TextBoxForm::m_ProcessKey),bbMethodDecl<t_VectorSite_TextBoxForm,void,bbInt>("OnKeyUp",&t_VectorSite_TextBoxForm::m_OnKeyUp),bbMethodDecl<t_VectorSite_TextBoxForm,void,bbInt>("OnKeyDown",&t_VectorSite_TextBoxForm::m_OnKeyDown),bbMethodDecl<t_VectorSite_TextBoxForm,void>("OnDraw",&t_VectorSite_TextBoxForm::m_OnDraw),bbMethodDecl<t_VectorSite_TextBoxForm,void>("Deactivate",&t_VectorSite_TextBoxForm::m_Deactivate),bbMethodDecl<t_VectorSite_TextBoxForm,void>("Activate",&t_VectorSite_TextBoxForm::m_Activate));
    }
  }decls;
